(function(exports) {
  function ApBar(x, y, width, height, colour = "rgba(255, 255, 255, 1)", game, type) {
  ...
  ApBar.prototype.drawCollisionBox = function() {
    this.ctx.beginPath();
  ...
  ApBar.prototype.calculateRemaining = function() {
    return this.game.actionPoints.points * 10
  }

  ApBar.prototype.reposition = function() {
